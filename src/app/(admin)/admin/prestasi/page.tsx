          ...
          <body>
            ...
            <div class="sig-section">
              <div class="sig-card">
                ...
                <div>Pengelola / Administrasi AHE</div>
                <div class="sig-space"></div>
                <div style="font-weight: bold; text-decoration: underline;">( Administrasi AHE )</div>
              </div>
            </div>
    ...
    <div className="space-y-6 font-body-md relative">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-body-md text-on-surface-variant mt-1">Catat nilai perkembangan harian murid per modul, filter periode, dan cetak rekapan.</p>
        </div>
